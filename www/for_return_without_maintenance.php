...
<div class="div_after_maintenance" id="div_after_maintenance">
  <button class="button2" ><a href="for_return_without_maintenance.php" target="main_iframe">Back</a></button><br>
        <form method="POST" action="for_return_without_maintenance.php" autocomplete="off" >
          ...
          <input type="text" name="refrence_work_order_no" id="refrence_work_order_no" style="display: none;">
           ...
           <p style="font-family: Arial;"> Are you sure?</p>
           <label for="">nu]sf] ldlt</label><br>
...
setTimeout(function() {
  window.location.href = 'already_taken_without_maintenance_page.php';
}, delayInMilliseconds);  
