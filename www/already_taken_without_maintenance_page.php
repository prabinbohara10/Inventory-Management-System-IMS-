...
<body id="body">
 ...
 <div class="action_completion" id="action_completion" style="display:none;">book</div>
  ...
  <div class="div1" id="div1" >
        ...
        <button style="position: relative;left: 15vw;font-family: HIMALAYA TT FONT;"><a href="for_return_without_maintenance.php">s)*]Dg]Zfg ug"{kg]{</a></button>
    ...
    // prepare sql
    $result = $conn->prepare("SELECT * FROM record_table Where status='s)*]Dg]Zfg ul/Psf]'");
    $result->execute();
