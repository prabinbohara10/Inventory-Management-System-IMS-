...
<body>
  ...
  $db = mysql_select_db("LMS", $server); 
  $query = mysql_query("SELECT * FROM books_table"); 


         echo "<table class='display_table' id='table1' style='width: 48vw; position: absolute;left: 0vw;top: 25vh;' > ";
